...
int main(void)
{
	...
	while (1)
	{
		OCR1B = ((uint32_t)ADC_read(0) * 800) /1023;		//scaling ADC return value from out of 1023 to out of 800
...
void PWM_Init(void)
{
	...
	// WGM1[0:2] = 100 for CTC mode operation
